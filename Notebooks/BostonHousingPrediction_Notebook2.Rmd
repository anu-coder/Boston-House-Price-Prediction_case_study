...
Next we shall be using the inbuilt library CARET to prdict the outcome using random forest. Along with that we shall be using cross validation tuning method to make the model more robust and effective.
...
MAAPE: Mean Arc-tangent Absolute Error </br>
